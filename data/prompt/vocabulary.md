...
2. kamu letakkan tempatnya di folder n3/vocabulary, dan beri nama vocabulary_{{angka}}.json.Untuk angka nya berdasarkan file yang saya attach + 1. Untuk gambar selanjutnya maka nama file nya vocabulary_{{angka+2}}.json, dan seterusnya
