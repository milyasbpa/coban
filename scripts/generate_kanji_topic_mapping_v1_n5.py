...
SRC = ROOT / "data" / "n5" / "kanji" / "kanji.json"
OUT = ROOT / "data" / "n5" / "kanji" / "kanji_topic_mapping_v1.json"
...
def main():
    ...
    summary = {
        ...
        "description": "All N5 kanji clustered by refined topics (no generic buckets), max 10 per group.",
    }
