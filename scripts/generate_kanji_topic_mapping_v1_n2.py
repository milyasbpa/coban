...
SRC = ROOT / "data" / "n2" / "kanji" / "kanji.json"
OUT = ROOT / "data" / "n2" / "kanji" / "kanji_topic_mapping_v1.json"
...
def main():
    ...
    # Final uniqueness and fill missing into a neutral specific bucket if any
    final_ids = []
    ...
    summary = {
        ...
        "description": "All N2 kanji clustered by refined topics (no generic buckets), max 10 per group.",
    }

    output = {"topic_categories": topic_categories, "summary": summary}
